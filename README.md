...
Mihomo（Clash Meta）配置覆写脚本，内置完善的 DNS 防泄露方案及 WebRTC 泄露防护，无需手动配置，开箱即用。

> [!IMPORTANT]
> **⚠️ 该脚本仅适用于覆写机场提供的订阅配置文件，请勿用于覆写自己手写的配置文件**

## 使用方式

复制脚本链接，导入到支持 JS 覆写的客户端（以 [Bettbox](https://github.com/appshubcc/Bettbox) / [FlClash](https://github.com/chen08209/FlClash) 为例）：


客户端中找到「脚本覆写」或「Mixin」功能，粘贴链接导入即可。
...
- [FlyCLash](https://github.com/Yrueil/flyclash)

## 致谢

感谢以下项目：

- [AIsouler/MyClash](https://github.com/AIsouler/MyClash) — 参考实现
- [MetaCubeX/mihomo](https://github.com/MetaCubeX/mihomo) — Mihomo 内核
- [MetaCubeX/meta-rules-dat](https://github.com/MetaCubeX/meta-rules-dat) — 规则集数据
- [DustinWin/ruleset_geodata](https://github.com/DustinWin/ruleset_geodata) — 规则集数据
- [Koolson/Qure](https://github.com/Koolson/Qure) — 图标资源
- [Mihomo Wiki](https://wiki.metacubex.one/config/) — 官方文档
